...
<center><img src="fac_port_node.svg" style="max-width: 40%; display: inline; margin-right: 20px"> <img src="fac_port_port.svg" style="max-width: 40%; display: inline; margin-left: 20px"></center>
